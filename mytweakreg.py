...
python mytweakreg.py --path='/grp/hst/wfc3v/martlin/nov_4_2016_Myles' --refim='filename.foo' --filter='F410M'
...
def mytweakreg_main(path, refim):
	...
	findpars = {'computesig':True,'threshold':100.,'conv_width':3.5,'peakmin':100.,'peakmax':90000.,'nsigma':1.5,
					'ratio':1.0, 'theta':0.0,'dqbits':None, 'use_sharp_round':False }
...
if __name__ == '__main__':
	...
	mytweakreg_main(args.path, args.refim)
